...
def plot_report(
    ...
    ax_b0.set_title("B1) Целевые рампы и CE-вероятности (пример класса 0)")
    ...
    ax_b1.set_title("B2) Целевые рампы и CE-вероятности (пример класса 1)")
    ...
    fig.suptitle(
        "Задача 1: визуальный отчёт (CE DONN) | "
